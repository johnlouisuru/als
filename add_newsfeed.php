...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $student_id = $_SESSION['user_id'] ?? null; // Get logged-in user ID
        ...
        $sql = "INSERT INTO newsfeed (feed_title, feed_content, file_attached_path, student_id, created_at) 
                VALUES (:feed_title, :feed_content, :file_attached_path, :student_id, NOW())";
